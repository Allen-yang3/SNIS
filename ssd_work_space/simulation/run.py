...
if __name__ == "__main__":
	...
	kmax_map = "2 %d %d %d %d "%( bw*1000000000, 400*bw*1/25, bw*4*1000000000, 400*bw*4/25)
	kmin_map = "2 %d %d %d %d "%( bw*1000000000, 400*bw*1/25, bw*4*1000000000, 400*bw*4/25)
	pmax_map = "2 %d %.2f %d %.2f"%(bw*1000000000, 0.2, bw*4*1000000000,0.2)
	#kmax_map = "5 %d %d %d %d %d %d %d %d %d %d"%(bw*1000000000, 400*bw/25, bw*4*1000000000, 400*bw*4/25, bw*.25*1000000000, 400*bw*.25/25, bw*.1*1000000000, 400*bw*.1/25, bw*.4*1000000000, 400*bw*.4/25)
	#kmin_map = "5 %d %d %d %d %d %d %d %d %d %d"%(bw*1000000000, 400*bw/25, bw*4*1000000000, 400*bw*4/25, bw*.25*1000000000, 400*bw*.25/25, bw*.1*1000000000, 400*bw*.1/25, bw*.4*1000000000, 400*bw*.4/25)
	#pmax_map = "5 %d %.2f %d %.2f %d %.2f %d %.2f %d %.2f"%(bw*1000000000, 0.2, bw*4*1000000000, 0.2, bw*.25*1000000000, 0.2, bw*.1*1000000000, 0.2, bw*.4*1000000000,0.2)
	#kmax_map = "2 %d %d %d %d "%( bw*0.10*1000000000, 400*bw*0.10/25, bw*0.40*1000000000, 400*bw*0.40/25)
	#kmin_map = "2 %d %d %d %d "%( bw*0.10*1000000000, 400*bw*0.10/25, bw*0.40*1000000000, 400*bw*0.40/25)
	#pmax_map = "2 %d %.2f %d %.2f"%(bw*0.10*1000000000, 0.2, bw*0.40*1000000000,0.2)
